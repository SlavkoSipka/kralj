      ...
      <div className="relative z-10 w-full">
        <div className="w-full pt-32">
          ...
          >
            <div className="container-fluid px-8">
              <div className="max-w-2xl">
                ...
                >
                  Otkrijte našu ekskluzivnu ponudu stanova u Vili IV. Svaka jedinica je pažljivo dizajnirana da pruži savršen spoj luksuza, udobnosti i funkcionalnosti.
                </p>
          ...
          <FloorSection
            ...
            apartments={VILLA4_GROUND_FLOOR_APARTMENTS}
          ...
          <FloorSection
            ...
            apartments={VILLA4_FIRST_FLOOR_APARTMENTS}
            onSelectApartment={(apt) => {
              setSelectedApartment(apt);
              open();
            }}
          ...
          <FloorSection
            title="Prvi Sprat"
            apartments={VILLA4_SECOND_FLOOR_APARTMENTS}
            onSelectApartment={(apt) => {
              setSelectedApartment(apt);
              open();
            }}
          ...
          <FloorSection
            title="Drugi Sprat"
            apartments={VILLA4_THIRD_FLOOR_APARTMENTS}
            onSelectApartment={(apt) => {
              setSelectedApartment(apt);
              open();
            }}
          ...
          <FloorSection
            ...
            apartments={VILLA4_PENTHOUSE_APARTMENTS}
            onSelectApartment={(apt) => {
              setSelectedApartment(apt);
              open();
            }}
          ...
          <div className="max-w-7xl mx-auto px-8">
            ...
            <div className="relative text-center mb-20">
              ...
              <p className="text-cream-100/90 text-xl max-w-2xl mx-auto leading-relaxed scroll-animate delay-300">
                Zainteresovani ste za neki od stanova u Vili IV? Pošaljite nam poruku i naš tim će vas kontaktirati u najkraćem mogućem roku.
              </p>
